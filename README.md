<img src="src/assets/img/deepsample-128.png" width="64"/>
...
```bash
clear; rm -rf dist .parcel-cache; node utils/bump-version.js && PORT=8899 yarn run dev
```

To build:

```bash
clear; rm -rf dist .parcel-cache; node utils/bump-version.js && yarn run build
```
